...
const handleNext = (e) => {
  ...
  const formData = {
    ...
    password,
    photo,
    disability: isDisabled === "yes" ? disability : null,
  };

  updateData(formData);
  localStorage.setItem("registrationData", JSON.stringify(formData)); // 👈 persist here

  navigate("/auth/teacherRegistrationStep2");
};
